...
> vtsly map with **zoom/rotate off** (rotate off so a rotor twist can't spin it) and the map a **VoiceOver
> Direct Touch** area. **One finger** drags the dot to explore (buzz + speech); **two fingers** drag to move
> the map. **Zoom** is the + / − buttons; the **• • • Options** menu **steps to the next Point of interest /
